...
@section('navbar-link')
<li>
	<a href="/drive" class="flex items-center text-blue-500 font-semibold hover:text-blue-500 hover:font-semibold">
		<img src="{{ asset('icon') }}/drive/storage-color.png" alt="Online Storage" class="mr-5">
		My Storage
	</a>
</li>
<li class="mt-5">
...
@else
	<div class="w-full h-12 rounded flex items-center px-4 bg-red-500 text-white">
		<p>Your drive is currently empty!
	</div>
@endif
@endsection
